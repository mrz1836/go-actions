...
Security is a priority. We maintain a proactive stance to identify and fix vulnerabilities in **go-actions**.

<br/>

## 🛠️ Supported & Maintained Versions
Any released version of **go-actions** that is not marked as deprecated is actively supported and maintained.
